...
intents.members = True  # Corresponds to `SERVER MEMBERS INTENT`
intents.presences = True  # Corresponds to `PRESENCE INTENT`
intents.message_content = True #Corresponds to `MESSAGE INTENT`
